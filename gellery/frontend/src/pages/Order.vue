                ...
                <div class="row g-5">
                    <div class="col-md-5 col-lg-4 order-md-last">
                        ...
                        <h3 class="text-center total-price">
                            {{ lib.getNumberFormatted(concutedPrice) }} 원
                        </h3>
                    </div>
                    <div class="col-md-7 col-lg-8">
                        ...
                        <form class="needs-validation" novalidate="">
                            ...
                            <div class="my-3">
                                ...
                                <div class="form-check">
                                    <input id="bank" name="paymentMethod" type="radio"
                                        class="form-check-input"  v-model="state.form.payment">
                                        <label class="form-check-label"
                            ...
                            <div class="row gy-3">
                                ...
                                <input type="text"
                                    class="form-control" id="cc-name" v-model="state.form.cardNumber">

                            </div>
                            <hr class="my-4"><button class="w-100 btn btn-primary btn-lg" @click="submit()">결제 하기</button>
                        </form>
                    </div>
                </div>
            </main>
...
export default {
    setup() {
        ...
        load();
        return { state, lib, concutedPrice ,submit }
    }
